...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        checkOutPage.enterPhoneNumber("0789456123");
        checkOutPage.enterAddress1("15, The Covent Garden");
        checkOutPage.enterCity("High street");
        checkOutPage.enterPostCode("SL6 9AS");
